...
global $sql1,$sql2,$result, $availableNumber;
  ...
  if($stop=="nonstop"){
    ...
    echo "<div class='alert alert-info'><strong>Resultat de la recherche: </strong>".$rowcount." resultat(s)</div>";
    ...
    if($rowcount3 == 0){
        echo "<div class='alert alert-info'><strong>  Resultat de la recherche: </strong>".$rowcount3." resultat</div>";
    }
    else{
 ...
 //echo the 1 stop flight
    ...
    $result4 = mysqli_query($con,$sql4);
     ...
     if($rowtotal==0){
        echo "<div class='alert alert-info'><strong>  Resultat de la recherche: </strong>".$rowtotal." resultat </div>";
     }else{
