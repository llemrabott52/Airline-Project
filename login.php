...
// {
	...
	echo '
			<head>
			<title>Utilisateur en ligne</title>
			<meta charset="utf-8">
	...
	<div class="container" id="homepage">
		<h1>Opps</h1>
		<p>Nom d\'utilisateur ou mot de passe incorrect, attendez 3s ou <a href="customersignin.html">cliquer ici pour retourner au page precedent !</a></p>
	</div>
