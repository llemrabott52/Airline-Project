...
$rowcount = mysqli_num_rows($result);
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo '<td>
            ...
            echo "<td><button type='button' class='btn btn-warning' onclick='myFunction()'>Pas de place disponible maintenant</button></td>";
        }
    ...
    echo "<div class='row'>
			  ...
			  <div class='col-sm-4'><p class='lead'>Total: <span id='total'>".$total." Ouguiya</span></p></div>
			  <div class='col-sm-4'><button type='submit' class='btn btn-primary'>Faire le paiement</button></div>
			</div>";
